...
def method_grid_search(pop_size=175, generations=300, crossover_rate=0.87, mutation_rate=0.15):
...
if __name__ == "__main__":
    ...
    gridsearch(generations=140)

    # best_distance, best_tour = method_grid_search(generations=350)
